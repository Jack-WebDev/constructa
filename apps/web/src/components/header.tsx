  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed inset-x-3 bottom-3 z-50 grid grid-cols-4 rounded-2xl border border-border/80 bg-card/95 p-1.5 shadow-2xl shadow-foreground/20 backdrop-blur-xl md:hidden"
      >
