...
export function GeneratorCatalog() {
  ...
  return (
    <main className="app-page mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <Card className="app-surface mt-8 rounded-2xl py-0">
      ...
      {entries.length === 0 ? (
        ...
        <ul className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          {entries.map((entry) => (
            <li key={entry.typeId}>
              <a
                className="app-interactive-card group block h-full rounded-2xl border border-border/80 bg-card/70 p-5 shadow-black/5 shadow-lg"
